...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<!-- antispam -->
	<tr> 
	  <td class="row1"><span class="gen">Are you a bot? Enter "no" if you're not a bot:</span></td>
	  <td class="row2"> 
		<input type="text" name="isbot" class="post" style="width: 100px"  size="10" maxlength="15" value="" />
	  </td>
	</tr>
