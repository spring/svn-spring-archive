...
public class CChannel extends javax.swing.JPanel implements IModule{
    ...
    public void Init(LMain L, final String channel) {
        ...
        Runnable doWorkRunnable = new Runnable() {
            ...
            public void run() {
                if(Channel.equalsIgnoreCase("main") || Channel.equalsIgnoreCase("news") || Channel.equalsIgnoreCase("new")){
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                        .addComponent(channelPrivateLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
