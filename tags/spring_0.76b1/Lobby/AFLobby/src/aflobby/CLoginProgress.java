...
public class CLoginProgress extends CView {
    ...
    public void NewEvent(CEvent e) {
        if (e.IsEvent("LOGININFOEND") == true) {
            ...
            SwingUtilities.invokeLater(doWorkRunnable);
        } else if (e.IsEvent("ACCEPTED") == true) {
            Runnable doWorkRunnable = new Runnable() {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/UI/Happy_Tree_Friends_ani.gif"))); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(progressbar, javax.swing.GroupLayout.DEFAULT_SIZE, 816, Short.MAX_VALUE)
                        .addContainerGap())
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(progressmessage, javax.swing.GroupLayout.DEFAULT_SIZE, 758, Short.MAX_VALUE)
                        .addGap(70, 70, 70))))
        );
