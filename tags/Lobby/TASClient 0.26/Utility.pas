...
procedure ReloadMapList; // will populate MapList and MapChecksums lists
...
//*** debug    MainForm.AddMainLog(MapName + ' ... ' + IntToStr(c) + ':' + CheckSums[CheckSums.Count-1], Colors.Info);
  end;
end;
