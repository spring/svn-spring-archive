...
begin
  ...
  MainForm.TryToSendData('MYBATTLESTATUS ' + IntToStr(GetMyBattleStatus) +  ' ' + IntToStr(TeamColors[MyTeamColorIndex]));
end;
...
begin
  ...
  MainForm.TryToSendData('UPDATEBATTLEINFO ' + IntToStr(BattleState.Battle.SpectatorCount) + ' ' + IntToStr(BoolToInt(LockedCheckBox.Checked)) + ' ' + IntToStr(Misc.HexToInt(Utility.MapChecksums[CurrentMapIndex])) + ' ' + Utility.MapList[CurrentMapIndex]);
end;
...
begin
  ...
  begin
    ...
    MainForm.TryToSendData('SAYBATTLEEX ' + 'suggests ' + Utility.MapList[MapsPopupStringList.ItemIndex]);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        MainForm.TryToSendData('UPDATEBOT ' + TBot(BattleState.Battle.Bots[VDTBattleClients.FocusedNode.Index - BattleState.Battle.Clients.Count]).Name + ' ' + IntToStr(TBot(BattleState.Battle.Bots[VDTBattleClients.FocusedNode.Index - BattleState.Battle.Clients.Count]).BattleStatus) + ' ' + IntToStr(TBot(BattleState.Battle.Bots[VDTBattleClients.FocusedNode.Index - BattleState.Battle.Clients.Count]).TeamColor));
      end;
    end;
  end
...
begin
  ...
  begin
    ...
    if GetClientNodeType(VDTBattleClients.FocusedNode.Index) = NormalClient then
    begin
      MainForm.TryToSendData('FORCETEAMCOLOR ' + TClient(BattleState.Battle.Clients[VDTBattleClients.FocusedNode.Index]).Name + ' ' + IntToStr(TeamColors[color]));
    end
    else if GetClientNodeType(VDTBattleClients.FocusedNode.Index) = NormalBot then
    begin
...
begin
  ...
  begin
    if GetClientNodeType(VDTBattleClients.FocusedNode.Index) = NormalClient then
    begin
      MainForm.TryToSendData('FORCESPECTATORMODE ' + TClient(BattleState.Battle.Clients[VDTBattleClients.FocusedNode.Index]).Name);
