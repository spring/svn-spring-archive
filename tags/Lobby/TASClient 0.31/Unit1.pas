...
const
  VERSION_NUMBER = '0.31'; // Must be float value! (with a period as a decimal seperator)
  ...
  SUPPORTED_SERVER_VERSIONS: array[0..0] of string = ('0.31'); // client can connect ONLY to server with one of these version numbers
  EOL = #13#10;
...
type
  ...
  TMainForm = class(TForm)
    ...
    Splitter1: TSplitter;
    ConnectButton2: TSpTBXSpeedButton;
    BotImage: TImage;
    ...
    procedure ConnectButton2Click(Sender: TObject);
  private
...
begin
  ...
  begin
    ...
    ConnectButton2.ImageIndex := Ord(Status.ConnectionState);
    Exit;
  end;
...
procedure TMainForm.ConnectButton2Click(Sender: TObject);
begin
