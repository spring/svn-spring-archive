...
const
  VERSION_NUMBER = '0.21'; // Must be float value! (with a period as a decimal seperator)
  ...
  SUPPORTED_SERVER_VERSIONS: array[0..1] of string = ('0.20', '0.21'); // client can connect ONLY to server with one of these version numbers
  EOL = #13#10;
