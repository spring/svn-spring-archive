{
  ...
  * fixed serious bug with disabled units list being loaded causing access violation exceptions
    on changing map or not launching spring upon strating the game.
...
const
  VERSION_NUMBER = '0.194'; // Must be float value! (with a period as a decimal seperator)
  ...
  SUPPORTED_SERVER_VERSIONS: array[0..4] of string = ('0.19', '0.191', '0.192', '0.193', '0.194'); // client can connect ONLY to server with one of these version numbers
  EOL = #13#10;
