...
if ($p == "" || $p == "help") echo "RESPOND\n* !stats games, !stats maps, !stats player <name>, http://unknown-files.net/stats/ *\n";
...
switch ($args[0]) {
	...
	case "leavers":
		echo file_get_contents("http://www.unknown-files.net/stats/leavers.php?p=".urlencode($args[1]));
	break;
	...
	case "":
		...
		echo "Game on map and mod usually lasts ".timeDiff($row[avgTime])." and is played by ".round($row[avgPlayers])." players \n";
