    ...
    def processCommand(self, command):
        ...
        #==================================================
            ...
            if len(command[1:]) >= 4:
                ...
                self.parent_window.debug_handler.output("Invalid ADDUSER (too few args," + len(command[1:]) + ") command, \"" + cmd_sentence + "\"", DEBUG_USELESS)
        elif command[0] == "REMOVEUSER":
            ...
            if len(command[1:]) == 2:
                ...
                self.parent_window.debug_handler.output("Invalid CLIENTSTATUS (too few args," + len(command[1:]) + ") command, \"" + cmd_sentence + "\"", DEBUG_USELESS)
        ...
        #==================================================
            ...
            if len(command[1:]) >= 12:
                ...
                self.parent_window.debug_handler.output("Invalid BATTLEOPENED (too few args," + len(command[1:]) + ") command, \"" + cmd_sentence + "\"", DEBUG_USELESS)
        elif command[0] == "JOINEDBATTLE":
