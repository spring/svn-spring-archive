...
const
  VERSION_NUMBER = '0.32'; // Must be float value! (with a period as a decimal seperator)
  ...
  SUPPORTED_SERVER_VERSIONS: array[0..0] of string = ('0.32'); // client can connect ONLY to server with one of these version numbers
  EOL = #13#10;
  ...
  try // try..finally
    ...
    begin
      ...
      begin
        ...
        TryToSendCommand('REQUESTUPDATEFILE', VERSION_NUMBER); // we ask server if he has an update for us
        Exit;
      end;
