...
uses
  ...
  JvDesktopAlertForm, DateUtils, Winsock;
...
const
  VERSION_NUMBER = '0.23'; // Must be float value! (with a period as a decimal seperator)
  ...
  SUPPORTED_SERVER_VERSIONS: array[0..1] of string = ('0.22', '0.23'); // client can connect ONLY to server with one of these version numbers
  EOL = #13#10;
