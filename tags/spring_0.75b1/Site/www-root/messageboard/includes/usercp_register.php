...
// O2sRtS3spa2E4mB2otAgr3e6eMan5tBl2ockBo2sT4ZTe3St to registration conditions/coppa
//
function show_coppa()
{
	...
	$template->assign_vars(array(
		...
		"U_AGREE_OVER13" => append_sid("profile.$phpEx?mode=register&amp;O2sRtS3spa2E4mB2otAgr3e6eMan5tBl2ockBo2sT4ZTe3St=true"),
		"U_AGREE_UNDER13" => append_sid("profile.$phpEx?mode=register&amp;O2sRtS3spa2E4mB2otAgr3e6eMan5tBl2ockBo2sT4ZTe3St=true&amp;coppa=true"))
	);
...
if ( $mode == 'register' && !isset($HTTP_POST_VARS['O2sRtS3spa2E4mB2otAgr3e6eMan5tBl2ockBo2sT4ZTe3St']) && !isset($HTTP_GET_VARS['O2sRtS3spa2E4mB2otAgr3e6eMan5tBl2ockBo2sT4ZTe3St']) )
{
...
else
{
	...
	$s_hidden_fields = '<input type="hidden" name="mode" value="' . $mode . '" /><input type="hidden" name="O2sRtS3spa2E4mB2otAgr3e6eMan5tBl2ockBo2sT4ZTe3St" value="true" /><input type="hidden" name="coppa" value="' . $coppa . '" />';
	if( $mode == 'editprofile' )
	{
