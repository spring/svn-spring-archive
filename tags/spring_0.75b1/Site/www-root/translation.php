...
require_once("include/session.php"); // For the database and general classes and functions.
...
elseif (1 == $_POST[trans_stage])
{
	...
	echo "
	<H2>Translation Page (<I>".$_POST[trans_section]."</I>)</H2>
	...
	foreach ($development as $key => $value)
	{
	    ...
	    echo "\n<TR><TD WIDTH=\"1%\" ALIGN=\"right\"><B>".$key."</B>:</TD><TD><TEXTAREA STYLE=\"width: 100%;\" ROWS=\"".$rows."\" NAME=\"".$key."\">".$trans_to[$key]."</TEXTAREA></TD><TD WIDTH=\"20%\">".htmlspecialchars($trans_from[$key], ENT_QUOTES, 'UTF-8')."</TD></TR>";
	}
	echo "
	</TABLE><BR>
	";
