...
BODY
{
background-color: #c8d2da; //#92919f; //EBEBEB;
...
.edge
{
// border: 1px solid #52517f; //#585f6b; //#b9c2ca;
padding: 1px;
}

.back
{
// background-image: url(<?= $cd ?>theme/<?= $site_theme ?>/img/aqua.png);
...
#introduction_title, #com_news_title, #pro_news_title, #participate_title, #news_into_title, #project_description_title, #developers_title
{
font-size: 18px;
font-weight: bold;
border-bottom: 1px groove #1C4069;
...
#project_description_title, #developers_title
{
background-image: url(<?= $cd ?>theme/<?= $site_theme ?>/img/text.png);
}
