...
if __name__ == "__main__":
    if (gtk_version >= (2, 10, 0) and pygtk_version >= (2, 10, 0)):
        ...
        parser.add_option("-p", "--profile-selection", action="store_true", dest="profile_selection", default=False, help="Startup Profile Setup")
        ...
        if options.profile_selection == True:
            os.spawnlp(os.P_NOWAIT, unity, unity, '-p')
        elif options.profile_setup == True:
