...
[Setup]
SourceDir=..\..\
OutputBaseFilename=UpspringInstaller
OutputDir=src\installer\
AppName=Upspring
AppVerName=Upspring 1.4 beta3
...
Name: "src"; Description: "Upspring C++ source files"; Types: fullsrc;
...
Source: "autoexec.lua"; DestDir: "{app}"; Components: main
