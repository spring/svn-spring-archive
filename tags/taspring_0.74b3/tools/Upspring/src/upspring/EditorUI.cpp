...
fltk::Window* RotatorUI::CreateUI(IEditor *editor) {
  fltk::Window* w;
   {fltk::Window* o = window = new fltk::Window(234, 253, "Object Rotator");
    w = o;
    o->labelsize(13);
    o->user_data((void*)(this));
    o->begin();
     ...
     {fltk::Group* o = new fltk::Group(8, 122, 219, 93, "Apply relative rotation");
      o->box(fltk::THIN_DOWN_BOX);
      o->begin();
     ...
     {fltk::Button* o = new fltk::Button(7, 219, 107, 27, "Reset rotation");
      o->callback((fltk::Callback*)cb_Reset);
    }
     {fltk::Button* o = new fltk::Button(120, 219, 106, 27, "Apply Rotation");
...
inline void EditorUI::cb_inputPosX_i(fltk::NumericInput* o, void*) {
  uiObjectStateChanged(&MdlObject::position, &Vector3::x, o);
}
...
inline void EditorUI::cb_inputPosY_i(fltk::NumericInput* o, void*) {
  uiObjectStateChanged(&MdlObject::position, &Vector3::y, o);
}
...
inline void EditorUI::cb_inputPosZ_i(fltk::NumericInput* o, void*) {
  uiObjectStateChanged(&MdlObject::position, &Vector3::z, o);
}
    ...
    o->begin();
     {fltk::Group* o = toolbox = new fltk::Group(0, 19, 37, 501);
      ...
      o->begin();
       ...
       {fltk::Button* o = selectTextureTool = new fltk::Button(2, 141, 35, 34);
        o->type(fltk::Button::RADIO);
...
tton to choose a color.");
       ...
       {fltk::InvisibleBox* o = new fltk::InvisibleBox(2, 274, 35, 226);
        o->set_vertical();
        fltk::Group::current()->resizable(o);
      }
     ...
     {fltk::TabGroup* o = new fltk::TabGroup(464, 19, 260, 505);
      ...
      o->begin();
       ...
       {fltk::Group* o = objectView = new fltk::Group(4, 23, 253, 481, "Objects");
        ...
        o->hide();
        o->begin();
         {fltk::MultiBrowser* o = objectTree = new fltk::MultiBrowser(22, 244, 204, 221, "Objects");
...
tation and scaling is removed here as well.");
         ...
         {fltk::Button* o = new fltk::Button(154, 84, 92, 23, "Uniform scale");
          o->callback((fltk::Callback*)cb_Uniform);
          o->tooltip("Scale the selected objects by a given factor");
        }
         {fltk::Button* o = new fltk::Button(108, 168, 70, 25, "Set name");
          o->callback((fltk::Callback*)cb_Set1);
          o->tooltip("Edit the name of the selected object");
        }
         {fltk::NumericInput* o = inputPosX = new fltk::NumericInput(57, 13, 66, 19, "X pos:");
          o->type(6);
          o->callback((fltk::Callback*)cb_inputPosX);
          o->when(fltk::WHEN_ENTER_KEY);
        }
         {fltk::NumericInput* o = inputPosY = new fltk::NumericInput(57, 37, 66, 19, "Y pos:");
          o->type(6);
          o->callback((fltk::Callback*)cb_inputPosY);
          o->when(fltk::WHEN_ENTER_KEY);
        }
         {fltk::NumericInput* o = inputPosZ = new fltk::NumericInput(57, 61, 66, 19, "Z pos:");
          o->type(6);
         ...
         {fltk::NumericInput* o = inputRotX = new fltk::NumericInput(79, 89, 66, 19, "X rotation:");
          o->type(6);
          o->callback((fltk::Callback*)cb_inputRotX);
          o->when(fltk::WHEN_ENTER_KEY);
          o->tooltip("Rotation around X axis");
        }
         {fltk::NumericInput* o = inputRotZ = new fltk::NumericInput(79, 137, 66, 19, "Z rotation:");
          o->type(6);
          o->callback((fltk::Callback*)cb_inputRotZ);
          o->when(fltk::WHEN_ENTER_KEY);
          o->tooltip("Rotation around Z axis");
        }
         {fltk::NumericInput* o = inputRotY = new fltk::NumericInput(79, 113, 66, 19, "Y rotation:");
          o->type(6);
          o->callback((fltk::Callback*)cb_inputRotY);
          o->when(fltk::WHEN_ENTER_KEY);
          o->tooltip("Rotation around Y axis");
        }
         {fltk::Button* o = new fltk::Button(181, 168, 63, 25, "Swap");
          o->callback((fltk::Callback*)cb_Swap);
        }
         {fltk::Button* o = new fltk::Button(153, 140, 91, 24, "Rotator UI");
     ...
     {fltk::MenuBar* o = menu = new fltk::MenuBar(2, 0, 645, 19);
      o->begin();
       ...
       {fltk::PopupMenu* o = new fltk::PopupMenu(9, 8, 95, 11, "Settings");
        o->begin();
       ...
       {fltk::PopupMenu* o = menuAnimation = new fltk::PopupMenu(9, 2, 105, 17, "Animation");
        o->begin();
       ...
       {fltk::PopupMenu* o = menuScript = new fltk::PopupMenu(9, 2, 69, 17, "Scripts");
        o->begin();
