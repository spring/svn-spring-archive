...
using System.Xml;
    ...
    public class Vector3{
        ...
        //static public bool operator !=(Vector3 first, Vector3 second) { if (second == null) return false; if (first == null) return false; return first.x != second.x || first.y != second.y || first.z != second.z; }
