...
#======================================================
 #	Default Online Battle Settings
#======================================================

DESCRIPTION = 'UnityLobby Test'

LOCK_BATTLE =         ['No', 'Yes']
LOCK_BATTLE_DEFAULT = 0

AI_NAMES = ['AI 1', 'AI 2', 'AI 3', 'AI 4', 'AI 5', 'AI 6', 'AI 7', 'AI 8', 'AI 9', 'AI 10', 'AI 11', 'AI 12', 'AI 13', 'AI 14', 'AI 15', 'AI 16']
...
# Metal Resources
METAL_RESOURCES = [0, 10000, 100, 1000]
METAL_RESOURCES_DEFAULT = 1000

# Energy Resources
ENERGY_RESOURCES = [0, 10000, 100, 1000]
ENERGY_RESOURCES_DEFAULT = 1000
...
# Max Units
MAX_UNITS = [0, 5000, 100, 1000]
MAX_UNITS_DEFAULT = 500
