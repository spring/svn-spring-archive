...
struct Model 
{
	...
	static Model* Load (const string& fn, bool Optimize=true, IProgressCtl& progctl=IProgressCtl());
	static bool Save (Model *mdl, const string& fn, IProgressCtl& progctl=IProgressCtl());
