...
type
  ...
  private
    ...
    FOldParentFormBorderStyle: TFormBorderStyle;
...
var
  ...
  ActivateTitleBarsOnStartUp: Boolean = True;
...
begin
  inherited;
  FActive := ActivateTitleBarsOnStartUp;
  ...
  FParentForm := GetParentForm(Self);
//  FOldParentFormBorderStyle := FParentForm.BorderStyle;
  ...
  begin
    ...
    try
      ...
      if Activate then begin
        ...
        // first check if FOldParentFormBorderStyle has been initialized at all (if we never activated the title bar, this value didn't get initialized as well!)
        if Integer(FOldParentFormBorderStyle) <> 0 then FParentForm.BorderStyle := FOldParentFormBorderStyle;
