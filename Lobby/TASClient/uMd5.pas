{ This unit is a copy of the one found at http://www.efg2.com/Lab/Library/UseNet/1999/0909.txt }
...
begin
  ...
  Inc(BufCount);
  if BufCount = 64 then UpdateDigest
end;
