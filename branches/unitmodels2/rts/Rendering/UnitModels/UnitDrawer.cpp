 ...
 */
void CUnitDrawer::UnitDrawingTexturesOff(CModel *model)
{
 ...
 */
void CUnitDrawer::UnitDrawingTexturesOn(CModel *model)
{
...
{
	CModel* model=modelParser->Load3DO(unitdef->model.modelpath.c_str(), 1, side);
