...
type
  ...
  public
    TakeAction: Byte; // 0 - load mod, 1 - get unit lists, 2 - get host udp port, 3 - Utility.ReInitLib, 4 - reload replay list from disk, 5 - reload map list. With 0, you also have to set ChangeToMod string!
