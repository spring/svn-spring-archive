...
class gui_battleroom(wx.Frame):
	...
	# /end edits ===================================================================
        ...
        self.label_battleroom_server_battleName = wx.StaticText(self.panel_battleroom_server, -1, "Battle Name")
        ...
        self.label_battleroom_server_mapName = wx.StaticText(self.panel_battleroom_server, -1, "Map Name")
        ...
        self.label_battleroom_server_modName = wx.StaticText(self.panel_battleroom_server, -1, "Mod Name")
        ...
        self.choice_battleroom_map_winConditionData = wx.Choice(self.panel_battleroom_server, -1, choices=["Normal", "Buildings", "Units", "Map default"])
	...
	# /end edits ===================================================================
        ...
        self.tree_battleroom_mod_fileList = wx.TreeCtrl(self.panel_battleroom_mod, -1, style=wx.TR_HAS_BUTTONS|wx.TR_LINES_AT_ROOT|wx.TR_MULTIPLE|wx.TR_MULTIPLE|wx.TR_DEFAULT_STYLE|wx.SUNKEN_BORDER)
...
#  Event fires when the "Ready" checkbox is clicked.
    ...
    def OnReady(self, event):
        userNumber = self.battle.indexFromName(self.user.name)
        ...
        try:
            ...
            for x in self.battle.userList:
                ...
                if self.currentUser == self.host:
                    ...
                    if x.name != self.currentUser.name:
                        status.Enable(False)
                ...
                faction.SetSelection(x.getFaction())
                sharedArmy.SetSelection(x.getTeamNumber() + 1)
                team.SetSelection(x.getAllyTeam() + 1)
                handicap.SetValue(int(x.getHandicap()) / 10)
                ready.SetValue(x.getReady())
...
# ==================================================================================================
    def joinBattle(self, data):
        try:
            ...
            if self.battle == None:
                self.Close(True)
                self.GetParent().debug_handler.output("self.battle is NoneType in gui_battleroom.py", DEBUG_ERROR)
                return False
...
# ==================================================================================================
    def InitConfig(self):
    	...
    	if config.ReadBool("/Global/RememberEverything") == True:
        	...
        	if not config.Exists("/Battleroom/Hardness"): config.WriteInt("/Battleroom/Hardness", DEFAULT_HARDNESS)
    		...
    		self.spin_battleroom_map_hardnessData.SetValue(config.ReadInt("/Battleroom/Hardness"))
...
# ==================================================================================================
    def SaveConfig(self):
    	...
    	if config.ReadBool("/Global/RememberEverything") == True:
    		...
    		config.WriteInt("/Battleroom/Hardness", self.spin_battleroom_map_hardnessData.GetValue())
...
# /end ParseMessage() ==============================================================================
  ...
  #==========================================================================================================
    ...
    def __set_properties(self):
        ...
        self.label_battleroom_server_battleName.SetMinSize((77, 17))
        self.text_battleroom_server_nameData.SetMinSize((150, 25))
        self.label_battleroom_server_mapName.SetMinSize((77, 17))
        self.text_battleroom_server_map.SetMinSize((150, 25))
        self.label_battleroom_server_modName.SetMinSize((77, 17))
        self.text_battleroom_server_mod.SetMinSize((150, 25))
