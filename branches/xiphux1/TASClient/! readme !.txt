...
In order to compile the sources, you'll have to install modified
TjanTracker component (I've included it with these sources) and also
...
I used Delphi 7 to compile the program.