...
!votetempadmin <name> - sets <name> as a new temp admin, use without parameter to remove any current tempadmin. If there is temp admin on server, other non-admin people have their rights reduced
...
!dlmod <modname/dllid> - downloads mod to server. You can either specify mod name or mod id (from unknown files)
...
!tempadmin <name> - sets <name> as a new temp admin, use without parameter to remove any current tempadmin. If there is temp admin on server, other non-admin people have their rights reduced.
