    ...
    ## ==================================================================================================    
        ...
        if self.isConnectionAlive():
            ...
            if self.receive_increment > 4:
                cache = {'UPDATEBATTLEDETAILS':None, 'UPDATEBATTLEINFO':None, 'MYBATTLESTATUS':None}
                while 1:
                    try: 
                        ...
                        if cmdToSend[:19] == 'UPDATEBATTLEDETAILS':
                            cache['UPDATEBATTLEDETAILS'] = cmdToSend
                        elif cmdToSend[:16] == 'UPDATEBATTLEINFO':
                            cache['UPDATEBATTLEINFO'] = cmdToSend
                        elif cmdToSend[:14] == 'MYBATTLESTATUS':
                            cache['MYBATTLESTATUS'] = cmdToSend
                        # TODO:
                ...
                if cache['UPDATEBATTLEDETAILS'] != None:
                    self.sendData(cache['UPDATEBATTLEDETAILS'])
                if cache['UPDATEBATTLEINFO'] != None:
                    self.sendData(cache['UPDATEBATTLEINFO'])
                if cache['MYBATTLESTATUS'] != None:
                    self.sendData(cache['MYBATTLESTATUS'])
...
#			print("[->] \"" + cmd_sentence + "\"")
    ...
    ## ==================================================================================================
        ...
        #==================================================
        if command[0] == "TASServer":
            if (command[1] != '0.31') and (command[1] != '0.32') and (command[1] != '0.33'):
        ...
        elif command[0] == "MYSTATUS":
            self.parent_window.mystatus(command)
        elif command[0] == "SAYPRIVATE":
        ...
        #==================================================
            ...
            self.parent_window.joinbattlefailed(command[1:])
        elif command[0] == "SAIDBATTLE":
            ...
            self.parent_window.clientbattlestatus(command[1:])
        elif command[0] == "REQUESTBATTLESTATUS":
            self.parent_window.requestbattlestatus()
        elif command[0] == "FORCEQUITBATTLE":
            self.parent_window.forcequitbattle()
        elif command[0] == "ADDSTARTRECT":
            self.parent_window.addstartrect(command[1:])
        elif command[0] == "REMOVESTARTRECT":
            self.parent_window.removestartrect(command[1])
            
        #==================================================
        #Bots and Units
        #==================================================
        elif command[0] == "DISABLEUNITS":
            self.parent_window.disableunits(command[0:])
        elif command[0] == "ENABLEUNITS":
            self.parent_window.enableunits(command[0:])
        elif command[0] == "ENABLEALLUNITS":
            self.parent_window.enableallunits(command[0:])
        elif command[0] == "ADDBOT":
            self.parent_window.addbot(command[1:])
        elif command[0] == "REMOVEBOT":
            self.parent_window.removebot(command[1:])
        elif command[0] == "UPDATEBOT":
            self.parent_window.updatebot(command[1:])
