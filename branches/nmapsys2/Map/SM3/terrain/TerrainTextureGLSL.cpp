...
public:
	...
	bool IsRect() {	return isRect; }

	bool isRect; // true in case of GL_TEXTURE_RECTANGLE_ARB, false in case of GL_TEXTURE_2D (NPOT)
...
struct ShaderBuilder
{
	...
	void BuildFragmentShader(PassType type, const std::string& operations, ShaderDef* sd)
	{
		...
		SNPRINTF(specularExponentStr, 20, "%3.3f", sd->specularExponent);
