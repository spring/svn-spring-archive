...
public:
	 ...
	 */
	GLXPBuffer(int requires, const int w, const int h, const bool sharedcontext = true, const bool shareobjects = true);
...
protected:
	 ...
	 *
	 * GLuint pointing to the attached textures
	 */
	unsigned int depthTexture, colorTexture;
};
