...
void CAdvTreeDrawer::DrawCallback::Draw(VisibilityNode *node)
{
...
void CAdvTreeDrawer::DrawShadowPass(void)
{
	...
	{
		TreeSquareStruct *tss=*i;
		if(abs(cy-tss->y)<=2 && abs(cx-tss->x)<=2 && drawDetailed)	//skip the closest squares
			return;
