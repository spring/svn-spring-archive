...
class config:
    ...
    def create(self):
        ...
        # TODO: Fix Saving & Updating Player Name
        ...
        self.player_name.set_text(self.spring_options['name'])
        ...
        self.team_nano_spray_combobox = combobox_setup(GLOBAL.Nano_Team_Colour, self.spring_options['team_nano_spray'], True)
        ...
        for i in range (0,len(GLOBAL.Resolution_X)):
            if GLOBAL.Resolution_X[i] == self.spring_options['resolution_x']:
        ...
        self.fullscreen_combobox = combobox_setup(GLOBAL.Fullscreen, self.spring_options['fullscreen'], True)
        ...
        self.shadows_combobox = combobox_setup(GLOBAL.Shadows, self.spring_options['shadows'], True)
        ...
        self.fsaa_spinner = spinner_create(GLOBAL.FSAA_Level, self.spring_options['fsaa'], True)
        ...
        self.ground_decals_spinner = spinner_create(GLOBAL.Ground_Decals, self.spring_options['ground_decals'], True)
        ...
        self.ground_detail_spinner = spinner_create(GLOBAL.Ground_Detail, self.spring_options['ground_detail'], True)
        ...
        self.grass_detail_spinner = spinner_create(GLOBAL.Grass_Detail, self.spring_options['grass_detail'], True)
        ...
        self.max_particles_spinner = spinner_create(GLOBAL.Max_Particles, self.spring_options['max_particles'], True)
        ...
        self.unit_lod_distance_spinner = spinner_create(GLOBAL.Unit_Lod_Dist, self.spring_options['unit_lod_dist'], True)
        ...
        self.adv_sky_combobox = combobox_setup(GLOBAL.Adv_Sky, self.spring_options['adv_sky'], True)
        ...
        self.dynamic_sky_combobox = combobox_setup(GLOBAL.Dynamic_Sky, self.spring_options['dynamic_sky'], True)
        ...
        self.adv_unit_shading_combobox = combobox_setup(GLOBAL.Adv_Unit_Shading, self.spring_options['adv_unit_shading'], True)
        ...
        self.reflective_water_combobox = combobox_setup(GLOBAL.Reflective_Water, self.spring_options['reflective_water'], True)
        ...
        self.sound_volume_spinner = spinner_create(GLOBAL.Sound_Volume, self.spring_options['sound_volume'], True)
        ...
        self.max_sounds_spinner = spinner_create(GLOBAL.Max_Sounds, self.spring_options['max_sounds'], True)
        ...
        self.verbose_level_spinner = spinner_create(GLOBAL.Verbose_Level, self.spring_options['verbose_level'], True)
        ...
        self.catch_ai_exceptions_combobox = combobox_setup(GLOBAL.Catch_AI_Exceptions, self.spring_options['catch_ai_exceptions'], True)
    ...
    def load_config(self):
        ...
        if self.platform == 'win32':
            self.spring_options = self.windows_load_spring_options()
        else:
            self.spring_options = self.unix_load_spring_options()       


    def save_config(self, widget=None):
        # Save Option Values
        if self.platform == 'win32':
            self.spring_options = self.windows_save_spring_options()
        else:
            self.spring_options = self.unix_save_spring_options()       

        self.battle.player_name_offline = self.player_name.get_text()
        self.battle.UpdatePlayerNameOffline()
        
        
    def save_player_name(self, name):
        if self.platform == 'win32':
            # TODO: Add Code to save Player Name under Windows Registry
            pass
        else:
            self.conf_temp.set('GAME', 'name', name)
    ...
    def unix_load_spring_options(self):
        ...
        if self.ini.has_option(self.profile, 'DefaultPlayerName') == True:
            name = self.ini.get(self.profile, 'DefaultPlayerName')
            options = ({'name':name})
        else:
            name = 'Player'
            options = ({'name':'Player'})
        self.battle.player_name_offline = name
    ...
    def unix_save_spring_options(self):
        self.ini.set(self.profile, 'DefaultPlayerName', self.player_name.get_text())
    ...
    def windows_load_spring_options(self):
        # TODO: Code for windows loading spring options
        pass

    def windows_save_spring_options(self):
        # TODO: Code for windows saving spring options
        pass
