...
# tabmanager object.
    ...
    host_name = ""
    host_ingame = 0         #ingame status 1 if host is ingame and 0 if he isn't
    host_ip = ""            #Host ip
...
#  of the battle class.
    ...
    def __init__(self, parent, server, battle_id, battle_type, natType, host, hostip, port, maxplayers, password, rank, mapname, name, mod, lan=False):
        ...
        self.host_ingame = self.battleStarted()
...
#  This returns True of the game is already started
    ...
    def battleStarted(self):
        self.host_ingame = self.host.inGame()
        return self.host.inGame()
