...
local function Exec()
	local ok,result
	result = upsFileSaveDlg("Enter txt file to save to:", "BOS script file(BOS)\0*.bos\0")
	if result ~= nil then
