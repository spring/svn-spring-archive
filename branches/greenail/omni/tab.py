    ...
    def __init__(self, parent, tabManager, name, tabTitle, channel=None):
        ...
        if channel != None:
            ...
            if self.channel.lan != True:
                ...
                list_users = {
                    0:("status_image",gui_lobby.gui_list.TYPE_IMAGE,"S",wx.LIST_FORMAT_LEFT,30),
                    1:("country",gui_lobby.gui_list.TYPE_IMAGE,"C",wx.LIST_FORMAT_LEFT,30),
                    2:("name",gui_lobby.gui_list.TYPE_TEXT,"Player",wx.LIST_FORMAT_LEFT,116),
                    3:("rank_image",gui_lobby.gui_list.TYPE_TEXT,"Rank",wx.LIST_FORMAT_LEFT,40),
                }
...
#  anything other than the channel object!
    ...
    def addUser(self, user, position):
        ...
        if user.isAway() == True and user.inGame() == True:
            ...
            self.tab_listPeople.InsertImageItem(position, status_image)
