...
const
  VERSION_NUMBER = '0.20'; // Must be float value! (with a period as a decimal seperator)
  ...
  SUPPORTED_SERVER_VERSIONS: array[0..0] of string = ('0.20'); // client can connect ONLY to server with one of these version numbers
  EOL = #13#10;
