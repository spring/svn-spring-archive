...
enum NETMSG {
	...
	NETMSG_CHECKSUMREQUEST  = 40, // Server asks for checksums
	NETMSG_CHECKSUMRESPONSE = 41, // Client sends checksums
	NETMSG_RESYNCREQUEST    = 42, // Request client to resync a unit (later maybe an object in general)
	NETMSG_RESYNCRESPONSE   = 43, // this is fwd by the server to all clients and includes the actual unit's 'memdump'
};
