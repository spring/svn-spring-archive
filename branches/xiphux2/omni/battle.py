...
# tabmanager object.
    ...
    battle_type = 0         #0 if game is normal, 1 if game is a replay
...
#  of the battle class.
    ...
    def __init__(self, parent, server, battle_id, battle_type, host, hostip, port, maxplayers, password, rank, mapname, name, mod, lan=False):
