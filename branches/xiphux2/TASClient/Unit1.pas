...
uses
  ...
  JvBaseDlg, JvDesktopAlert, JvDesktopAlertForm, DateUtils;
...
const
  VERSION_NUMBER = '0.196'; // Must be float value! (with a period as a decimal seperator)
  ...
  SUPPORTED_SERVER_VERSIONS: array[0..2] of string = ('0.194', '0.195', '0.196'); // client can connect ONLY to server with one of these version numbers
  EOL = #13#10;
