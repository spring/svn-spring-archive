...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Unit1, Misc;
...
type
  ...
  public
    TakeAction: Byte; // 0 - load mod, 1 - get unit lists, 2 - get host udp port, 3 - Utility.ReInitLib. With 0, you also have to set ChangeToMod string!
