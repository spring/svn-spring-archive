...
uses
  ...
  Dialogs, HttpProt, StdCtrls, Buttons, ComCtrls, Unit1, Misc, ShellAPI;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ShellExecute(MainForm.Handle, 'open', PChar(DownloadFile.FileName), nil, PChar(ExtractFilePath(Application.ExeName)), SW_SHOWNORMAL);
...
begin
  ...
  ReceivedLabel.Caption := 'Received ' + Misc.FormatFileSize(HttpCli1.RcvdStream.Size) + ' KB';
