...
public class TASServer {
	...
	static final String VERSION = "0.161";
	...
	private static boolean startServer(int port) {
		try {
			...
			System.out.println("Default socket rcv buff size: " + serverSocket.getReceiveBufferSize());
	...
	public static synchronized boolean tryToExecCommand(String command, Client client) {
		...
		/* some admin specific commands: */
			...
			System.out.println("*** SCRIPTSTART ACCEPTED");//*****
		}				
			...
			System.out.println("*** SCRIPT LINE ADDED");//*****
		}				
			...
			System.out.println("*** SCRIPTEND ACCEPTED");//*****
			System.out.println("*** FINAL SCRIPT SIZE: " + bat.replayScript.size());//*****
		}				
		else {
			// unknown command!
			return false;
