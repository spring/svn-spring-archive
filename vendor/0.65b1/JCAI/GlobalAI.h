...
public:
	...
	virtual BuildTask* GetNewTask () = 0;
...
public:
	...
	static CfgList* LoadConfig (IGlobalAICallback *cb);
	...
	{
		return energy * 0.05f + metal * 0.95f;
	}

	inline float ResourceValue (const ResourceInfo& res)
	{
		return res.energy * 0.05f + res.metal * 0.95f;
	}
};

extern CfgList* rootcfg;
