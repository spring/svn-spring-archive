...
{
  October 1, 2005:
  - added <Send report> button, as seen in ExceptDlgMail.pas example. (Betalord)
}
...
const
  SendBugReportAddress = 'lobbycrash@clan-sy.com';
...
begin
  ...
  try
    ...
    Body := CrashDetailsDialog.RichEdit1.Text + #13#10 + StrRepeat(ReportNewBlockDelimiterChar, ReportMaxColumns) + #13#10 + ReportAsText;
    SaveTaskWindows;
    try
      Send(True);
    finally
