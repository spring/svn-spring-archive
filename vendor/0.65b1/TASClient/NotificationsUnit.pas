...
type
  ...
  TNotificationType = (nfJoinedChannel,nfJoinedBattle, nfStatusInBattle);
  {
    Notification types:
...
uses Unit1, PreferencesFormUnit, StringParser, AddNotificationFormUnit;
...
begin
  ...
  try
    ...
    begin
      ...
      if s = '#' then Continue; // skip comments
